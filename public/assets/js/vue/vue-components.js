...
Vue.component('sankey', require('./templates/charts/sankey.vue').default);
Vue.component('chart_lines_and_pie', require('./templates/charts/lines_and_pie.vue').default); // TODO: to be converted to chart2.mixin
