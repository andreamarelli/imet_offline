    ...
    export default {
        ...
        methods: {
            ...
            buildLayer(){
                ...
                [source_layer_id, legend, expression] = this[this.method]();
            ...
            percent_terrestrial_area_protected(){
                ...
                let legend = this.generateGradientPalette(7);

                let data_percentage = this.choropleth(this.input_data.percentage, legend);
            ...
            iucn_categories() {
                ...
                labels.forEach(function(label, index) {
                    ...
                    legend.push({color: palette[index], label: label});
                });
                expression.push('rgba(0,0,0,0)');
            ...
            country_charter_quality_label(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_need_skills_identified(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_research_data_report(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_adapted_orientations(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_percentage_completion_national(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_environmental_education(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            ...
            country_rate_action_plan_strategy(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            ...
            country_reports_dialogue_meetings(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_data_marketing(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_data_media(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_volume_artisanal(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_volume_revenue_ntfp(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_efficiency_score(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_completed_actions(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
            country_area_defended(){
                return this.__automatic__hightlight('countries', 'iso3');
            },
