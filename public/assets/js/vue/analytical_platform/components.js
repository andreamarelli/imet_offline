...
Vue.component('layer_card', require('./components/layer/layer_card.vue').default);
Vue.component('layer_toggle', require('./components/layer/layer_toggle.vue').default);
Vue.component('data_driven_layer_toggle', require('./components/layer/data_driven_layer_toggle.vue').default);
...
Vue.component('convergence_plan_radar', require('./components/convergence_plan_radar.vue').default);
Vue.component('country_list', require('./components/country_list.vue').default);
