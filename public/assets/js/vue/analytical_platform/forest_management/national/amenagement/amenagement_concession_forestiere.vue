<template>
    ...
    <div>     
        <div class="list-key-numbers">
            ...
            <div>
                <div class="content">
                    <span class="txt">{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.attributed') }}</span>
            ...
            <div>
                <div class="content">
                    <span class="txt">{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.planning') }}</span>
                    <span class="number">
            ...
            <div>
                <div class="content">
                    <span class="txt">{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.durability') }}</span>
                    <span class="number">
            ...
            <div>
                <div class="content">
                    <span class="txt">{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.legality') }}</span>
                    <span class="number">
        ...
        <div v-if="Array.isArray(api_data.forest_concessions.durability_details) && api_data.forest_concessions.durability_details.length">
            <table class="lines">
                <thead>
                    <tr>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.concession_name') }}</th>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.concessionaire_name') }}</th>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.certified_area') }}</th>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.sustainability_certificate') }}</th>
                    </tr>
                </thead>
            ...
            <table class="lines">
                <thead>
                    <tr>
                        ...
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.concessionaire_name') }}</th>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.certified_area') }}</th>
                        <th>{{ Locale.getLabel('mapping.platform.cards.forest_management.national.sections.planning.legality_certificate') }}</th>
                    </tr>
                </thead>
