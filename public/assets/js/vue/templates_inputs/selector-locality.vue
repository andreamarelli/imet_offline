<template>
    ...
    >
        ...
        <template v-slot:modal_content>
            ...
            <modal_api_search
                    :parent-id=id
                    search-url='ajax/search/localities'
            >
                <template v-slot:resultItem="{ item }">
                    <td><b>{{ item.name1}}</b></td>
                </template>
...
<style lang="scss" type="text/scss" scoped>
    ...
    .modal_selector.selector-localities{
    ...
    export default {
        ...
        methods: {
            ...
            resultTableHeader(){
                return [
                    '',
                    Locale.getLabel('form/locality.name'),
                ]
            },

            confirmSelection(){
                this.confirmedValue = this.selectedValue.name1;
