...
Vue.component('imet_basic_bars',    require('./templates/imet_basic_bars.vue').default);
...
Vue.component('label-cloud',                            require('./templates_inputs/label-cloud.vue').default);


// Components
// Vue.component('modal-selector',                         require('./abstract_components/modal-selector.vue').default);
Vue.component('modal-selector',                         require('./templates_inputs/components/modal-selector.vue').default);

// Components for analytical platform
require('./analytical_platform/components');
//Components for scaling up
