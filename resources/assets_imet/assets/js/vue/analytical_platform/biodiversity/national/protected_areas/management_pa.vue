    ...
    <div>
        ...
        <div class="list-key-numbers">
            <div>
                ...
                <div class="content">
                    <span>{{ Locale.getLabel('mapping.common.protected_areas_with') }} <span class="highlighted">{{ Locale.getLabel('mapping.common.development_plan') }}</span> {{ Locale.getLabel('mapping.common.or_management_plan') }}</span>
            ...
            <div>
                ...
                <div class="content">
                    <span>{{ Locale.getLabel('mapping.common.protected_areas_effectiveness') }} <span class="highlighted">IMET</span></span>
        ...
        <div class="list-key-numbers terrestrial_and_marine">
            ...
            <div>
                ...
                <div class="content">
                    <span class="txt">
                        soit <span class="number">{{ api_data.terrestrial.number_assessed_imet | pretty_number }}</span> {{ Locale.getLabel('mapping.common.assessed_with') }} IMET
                    </span>
            ...
            <div class="list-head">{{ Locale.getLabel('mapping.common.maritime') }}</div>
            <div>
                <i class="icon-svg icon-check"></i>
                <div class="content">
                    <span class="txt">
                        soit <span class="number">{{ api_data.marine.number_assessed_imet | pretty_number }}</span> {{ Locale.getLabel('mapping.common.assessed_with') }} avec IMET
                    </span>
