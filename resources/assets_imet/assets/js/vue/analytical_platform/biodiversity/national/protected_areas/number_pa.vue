    ...
    <div>
        ...
        <div class="list-key-numbers">
            <div>
                ...
                <div class="content">
                    <span class="txt">{{ api_data.number_total | pretty_number }} {{ Locale.getLabel('mapping.common.protected_areas') }}</span>
                    <span class="number">{{ api_data.area_protected.total | pretty_number }}<sup>km²</sup></span>
                </div>
                <layer_toggle
                    layer_key="protected_areas"
                    group_key="overlays"
        ...
        <div class="list-key-numbers grid_two_cols pa_numbers">
            <div>
                ...
                <div class="content">
                    <span>
                        avec <span class="highlighted">{{ Locale.getLabel('mapping.common.brigades_ecoguards') }}</span>
                    </span>
            ...
            <div>
                ...
                <div class="content">
                    <span>
                        avec <span class="highlighted">{{ Locale.getLabel('mapping.common.reception_facilities') }}</span>
                    </span>
            ...
            <div>
                ...
                <div class="content">
                    <span>
                        <span class="highlighted">{{ Locale.getLabel('mapping.common.sustainable_labeled') }}</span>
                    </span>
            ...
            <div>
                ...
                <div class="content">
                    <span>
                        <span class="highlighted">{{ Locale.getLabel('mapping.common.cross_border') }}</span>
                    </span>
        ...
        <div class="list-key-numbers terrestrial_and_marine">
            <div class="list-head">{{ Locale.getLabel('mapping.common.terrestrial') }}</div>
            <div>
                <i class="icon-svg icon-trees"></i>
                <div class="content">
                <span class="txt">
                    {{ api_data.terrestrial.number | pretty_number}} {{ Locale.getLabel('mapping.common.terrestrial') }}
                </span>
            ...
            <div>
                ...
                <div class="content">
                    <span class="txt">
                        {{ api_data.terrestrial.number_assessed | pretty_number }} {{ Locale.getLabel('mapping.common.assessed') }} 
            ...
            <div class="list-head">{{ Locale.getLabel('mapping.common.assessed') }} </div>
            <div>
                <i class="icon-svg icon-corals"></i>
                <div class="content">
                        <span class="txt">
                            {{ api_data.marine.number | pretty_number }} {{ Locale.getLabel('mapping.common.assessed') }} 
                        </span>
            ...
            <div>
                ...
                <div class="content">
                        <span class="txt">
                            {{ api_data.marine.number_assessed | pretty_number }} {{ Locale.getLabel('mapping.common.assessed') }}
                        </span>
