    ...
    <span>
        ...
        <div class="modal-header">
            ...
            <div class="modal_search">
                ...
                <!-- Search button -->
                <button type="button" class="btn btn-sm act-btn-basic"
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            //$("#add_button_popup").prop("disabled", true ); ce ne marche pas----------------------------------------------------------------------------------------------
        },
                    ...
                    $.ajax({
                        ...
                        cache: false
                            ...
                            .done(function (response) {
                                _this.searchResults = response['records'];
...
//                            _this.recordFound=response.ElementFound;
//                            console.log(_this.recordFound);
                            })
                            .fail(function () {
                                // _this.setErrors();
                            })
            ...
            createKeywords() {
                ...
                $.ajax({
                    ...
                    cache: false
                        ...
                        .done(function (response) {
                            _this.applySearchAfterCreatekeywords(response);
                            _this.searchKey = response.word;
                            _this.closeModal();
                ...
                $.ajax({
                    ...
                    cache: false
                        ...
                        .done(function (response1) {
                            _this.searchResults = response1['records'];
                            _this.showList = _this.searchResults;
                            _this.totalCount = _this.searchResults.length;
                            _this.searchExecuted = true;
                            _this.isSearching = false;
                            _this.afterSearch(response1);
                        })
                        .fail(function () {
                        })
            },
            closeModal(){
                let _this = this;
//                $('#createkeywords_popup').modal('hide');
//                $('#createkeywords_popup').modal('hide');  
