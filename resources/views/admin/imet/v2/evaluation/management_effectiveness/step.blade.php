...
$assessment_step = json_decode(\App\Http\Controllers\Imet\ImetEvalControllerV2::assessment($item_id, $step, true)->getContent());

?>


<div id="assessment_step_{{ $step }}" class="assessment_step">
    <h5>@lang('form/imet/v2/common.steps_eval.'.$step)</h5>
    ...
    @if($step=='context')
        ...
        <div style="margin-bottom: 20px;">
            <div v-for="(item, index) in intermediate_values">
                @include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => '0_to_100', 'values' => 'intermediate_values'])
            </div>
        </div>

        {{-- C1->C3 statistics --}}
        <div style="margin-bottom: 30px;">
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => '0_to_100', 'values' => 'values', 'index' => 'c1'])</div>
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => 'minus100_to_100', 'values' => 'values', 'index' => 'c2'])</div>
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => 'minus100_to_0', 'values' => 'values', 'index' => 'c3'])</div>
        </div>
    ...
    @elseif($step=='process')
        ...
        <div style="margin-bottom: 20px;">
            <div v-for="(item, index) in values">
                @include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => '0_to_100_full_width', 'values' => 'values'])
            </div>
        </div>
    ...
    @elseif($step=='outcomes')
        ...
        {{-- Step related statistics --}}
        <div style="margin-bottom: 20px;">
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => '0_to_100', 'values' => 'values', 'index' => 'oc1'])</div>
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => 'minus100_to_100', 'values' => 'values', 'index' => 'oc2'])</div>
            <div>@include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => 'minus100_to_100', 'values' => 'values', 'index' => 'oc3'])</div>
        </div>
    ...
    <div style="padding-top: 20px; border-top: 1px solid #aaa;">
        <div>
            @include('admin.imet.v2.evaluation.management_effectiveness.components.histogram_row', ['row_type' => '0_to_100_full_width', 'synthetic_indicator' => true])
        </div>
    </div>
