...
<table id="{{ $table_id }}" class="table module-table">
    ...
    <tr>
        ...
        @endforeach
        <th class="text-center">
            {{ ucfirst(trans('form/imet/v1/context.FinancialResourcesBudgetLines.fields.function_costs')) }}
        </th>
        <th class="text-center">
            {{ ucfirst(trans('form/imet/v1/context.FinancialResourcesBudgetLines.fields.percentage')) }}
        </th>
    </tr>
    </thead>
