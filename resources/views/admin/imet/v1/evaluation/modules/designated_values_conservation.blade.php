...
$view_groupTable = App\Library\Ofac\Module::injectAverageInGroup($view_groupTable, 'group2', 3, 2);
$view_groupTable = App\Library\Ofac\Module::injectAverageInGroup($view_groupTable, 'group3', 3, 2);
$view_groupTable = App\Library\Ofac\Module::injectAverageInGroup($view_groupTable, 'group4', 3, 2);
