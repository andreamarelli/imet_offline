...
(
    ...
    intervention1_activity       text,
    intervention1_activity_year1 boolean default false,
    intervention1_activity_year2 boolean default false,
    intervention1_activity_year3 boolean default false,
    intervention1_activity_year4 boolean default false,
    intervention1_activity_year5 boolean default false,
    ...
    intervention2_activity       text,
    intervention2_activity_year1 boolean default false,
    intervention2_activity_year2 boolean default false,
    intervention2_activity_year3 boolean default false,
    intervention2_activity_year4 boolean default false,
    intervention2_activity_year5 boolean default false,
    ...
    intervention3                 text,
    intervention3_year1           boolean default false,
    intervention3_year2           boolean default false,
    intervention3_year3           boolean default false,
    intervention3_year4           boolean default false,
    intervention3_year5           boolean default false,
    intervention3_activity       text,
    intervention3_activity_year1 boolean default false,
    intervention3_activity_year2 boolean default false,
    intervention3_activity_year3 boolean default false,
    intervention3_activity_year4 boolean default false,
    intervention3_activity_year5 boolean default false,
    intervention3_other           text,
    intervention3_other_year1     boolean default false,
    intervention3_other_year2     boolean default false,
    intervention3_other_year3     boolean default false,
    intervention3_other_year4     boolean default false,
    intervention3_other_year5     boolean default false,
    "UpdateDate"                  character varying(30),
    group_key                     character varying(50),
    CONSTRAINT "FormID_fk" FOREIGN KEY ("FormID") REFERENCES imet_oecm.imet_form ("FormID") MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE
);
