...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_c12(item_class text, tablename text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
BEGIN
  ...
  sql := 'select "FormID",'''||item_class||'''::text as section ,
	     ...
	     where "EvaluationScore" is not null and "EvaluationScore">=0 and "SignificativeClassification" is not null
	     group by "FormID"
	     order by "FormID"';
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_c13(item_class text, tablename text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_c14(item_class text, tablename text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_c2(item_class text, tablename text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
BEGIN
  ...
  sql := 'select "FormID",'''||item_class||'''::text as section ,
		...
		where "EvaluationScore" is not null and "EvaluationScore" !=''-99''::int and "EvaluationScore" > -4
		group by "FormID"
		order by "FormID"';
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_c3(item_class text, tablename text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_i2(item_class text, tablename text, field_value text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_i5(item_class text, tablename text, field_value text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_pr1(item_class text, tablename text, field_value text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_cm_pr13(item_class text, tablename text, field_value text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_group_all(item_class text, tablename text, field_value text, field_group_element text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_rank_all(tablename text, field_value text, item_class text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
...
CREATE FUNCTION imet_assessment.get_imet_evaluation_stats_table_all(item_class text, tablename text, field_value text) RETURNS TABLE(formid integer, section text, value_p double precision)
LANGUAGE plpgsql
AS $$
