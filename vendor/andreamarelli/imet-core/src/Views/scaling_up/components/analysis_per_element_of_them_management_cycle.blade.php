            ...
            <div class="col-sm">
                <div class="align-items-center">
                    <container_analysis_management_cycle
                        ...
                        :guidance="'{{trans('imet-core::analysis_report.guidance.context.main')}}'"
                        :url=url
                        :type="'context'"
                    ...
                    <container_analysis_management_cycle
                        ...
                        :guidance="'{{trans('imet-core::analysis_report.guidance.planning.main')}}'"
                    ...
                    <container_analysis_management_cycle
                        :guidance="'{{trans('imet-core::analysis_report.guidance.inputs.main')}}'"
                    ...
                    <container_view
                        :guidance="'{{trans('imet-core::analysis_report.guidance.process.main')}}'"
                    ...
                    <container_analysis_management_cycle
                        :guidance="'{{trans('imet-core::analysis_report.guidance.outputs.main')}}'"
                    ...
                    <container_analysis_management_cycle
                        :guidance="'{{trans('imet-core::analysis_report.guidance.outcomes.main')}}'"
