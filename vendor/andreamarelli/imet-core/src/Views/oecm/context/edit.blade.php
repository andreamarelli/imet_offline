...
use AndreaMarelli\ImetCore\Controllers\Imet\oecm\ContextController;
...
@section('content')
    ...
    @include('modular-forms::page.steps', [
        'url' => route(Controller::ROUTE_PREFIX . 'context_edit', ['item' => $item->getKey()]),
        'current_step' => $step,
    ...
    <div class="imet_modules">
        ...
        @if($step === 'stakeholder_analysis' && Role::hasRequiredAccessLevel(_AnalysisStakeholders::class))
            @include('imet-core::oecm.context.modules.analysis_stakeholder_summary', [
                'form_id' => $item->getKey()
            ])
        @endif
