...
$dom->filter('h5.group_title_'.$definitions['module_key'].'_group0')->before('<h3 style="margin-bottom: 20px;">'.trans('imet-core::oecm_context.StakeholdersNaturalResources.titles.title0').'</h3>');
$dom->filter('h5.group_title_'.$definitions['module_key'].'_group5')->before('<h3 style="margin-bottom: 20px;">'.trans('imet-core::oecm_context.StakeholdersNaturalResources.titles.title1').'</h3>');
$dom->filter('h5.group_title_'.$definitions['module_key'].'_group7')->before('<h3 style="margin-bottom: 20px;">'.trans('imet-core::oecm_context.StakeholdersNaturalResources.titles.title2').'</h3>');
$dom->filter('h5.group_title_'.$definitions['module_key'].'_group9')->before('<h3 style="margin-bottom: 20px;">'.trans('imet-core::oecm_context.StakeholdersNaturalResources.titles.title3').'</h3>');
