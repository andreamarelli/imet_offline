...
return [
    ...
    'assessment' => [
        'ctx101' => [
            'CTX 1.0.1',
            'Responsabilité du remplissage du formulaire : Équipe de gestion et partenaires et soutien externe pour l’analyse et l’évaluation de la gestion'
        ],
        'ctx102' => [
            'CTX 1.0.2',
            'Responsabilité de remplir le formulaire : Équipe de gestion, partenaires et soutien externe pour l’analyse et l’évaluation de la gestion'
        ],
        'c1' => [
            'C1',
            'Désignations'
        ...
        'p1' => [
            'P1',
            'Adéquation des dispositions légales et réglementaires'
        ],
        'p2' => [
            'P2',
        ...
        'i2' => [
            'I2',
            'Capacités d’entités/parties prenantes spécifiques ou combinées en matière de gestion et de gouvernancee'
        ],
        'i3' => [
            'I3',
            'Budget actuel'
        ...
        'pr1_6' => [
            'PR1-6',
            'Systèmes et processus de gestion interne'
        ],
        'pr7_9' => [
            'PR7-9',
            'Gestion / Protection des valeurs'
        ],
        'pr10_12' => [
            'PR10-12',
        ...
        'op1' => [
            'O/P1',
            'Mise en œuvre du plan de travail/action'
        ],
        'op2' => [
            'O/P2',
            'Contrôle de l’aire'
