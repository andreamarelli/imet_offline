...
class BudgetSecurization extends Modules\Component\ImetModule_Eval
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ['name' => 'Percentage',        'type' => 'blade-imet-core::components.rating-0to5',   'label' => trans('imet-core::v2_evaluation.BudgetSecurization.fields.Percentage')],
            ['name' => 'EvaluationScore',   'type' => 'blade-imet-core::components.rating-0to3',   'label' => trans('imet-core::v2_evaluation.BudgetSecurization.fields.EvaluationScore')],
