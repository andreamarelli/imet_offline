...
class ManagementPlan extends Modules\Component\ImetModule_Eval
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ...
            ['name' => 'VisionAdequacy',     'type' => 'rating-0to3',    'label' => trans('imet-core::v2_evaluation.ManagementPlan.fields.VisionAdequacy')],
            ['name' => 'PlanAdequacyScore',     'type' => 'rating-0to3',    'label' => trans('imet-core::v2_evaluation.ManagementPlan.fields.PlanAdequacyScore')],
