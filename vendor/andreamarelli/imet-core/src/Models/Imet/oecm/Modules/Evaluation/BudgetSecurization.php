...
{
    protected $table = 'imet_oecm.eval_budget_securization';
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ['name' => 'Percentage',        'type' => 'imet-core::rating-0to5',   'label' => trans('imet-core::oecm_evaluation.BudgetSecurization.fields.Percentage')],
            ['name' => 'EvaluationScore',   'type' => 'imet-core::rating-0to3',   'label' => trans('imet-core::oecm_evaluation.BudgetSecurization.fields.EvaluationScore')],
