...
{
    protected $table = 'imet_oecm.eval_law_enforcement_implementation';
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ...
            ['name' => 'Adequacy',  'type' => 'imet-core::rating-0to3WithNA',  'label' => trans('imet-core::oecm_evaluation.LawEnforcementImplementation.fields.Adequacy')],
