...
class Module extends EntityModel
{
    ...
    {
        $this::$foreign_key = $this::$foreign_key === null ? $this->primaryKey : $this::$foreign_key; // In case foreign_key is null use primary_key
     ...
     * @return String
     */
    public function fieldTypeByName($name)
    {
     ...
     * @return array
     */
    public function fieldLabels($only_fields = [])
    {
     ...
     * @return bool
     */
    public static function hasRecord($form_id = null)
    {
        if ($form_id !== null) {
            $model = new static();
     ...
     * @return array
     */
    protected static function successResponse($form_id)
    {
     ...
     * @return array|null
     */
    public static function validateRules($formID, $step = null)
    {
        $errors = null;
