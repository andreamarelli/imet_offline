...
trait Upload {
     ...
     */
    public static function uploadFile($uploaded_file)
    {
    ...
    public static function getFileModelHash($class, $field, $id)
    {
    ...
    public static function getFileTypeByHash($hash)
    {
        $params = File::decodeHash($hash);
        if($params === null) abort('404');
     ...
     * @return mixed
     */
    public static function parse_uploads_from_model($collection)
    {
     ...
     * @return array
     */
    private function parse_uploads()
    {
     ...
     * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException
     */
    public static function getUploadFileContent($upload)
    {
        $storage = \Storage::disk(self::$UPLOAD_DISK);
        return $storage->get(self::$UPLOAD_PATH.$upload['temp_filename']);
    }

    public static function getUploadFileInfo($upload)
    {
        $storage = \Storage::disk(self::$UPLOAD_DISK);
