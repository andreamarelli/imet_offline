...
{ 
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_info_EvaluationQuestion = trans('form/imet/v2/evaluation.Menaces.module_info_EvaluationQuestion');
        $this->module_info_Rating = trans('form/imet/v2/evaluation.Menaces.module_info_Rating');
    ...
    public static function getVueData($form_id, $collection = null)
    {
        ...
        $vue_data['warning_on_save'] =  trans('form/imet/v2/evaluation.Menaces.warning_on_save');
        return $vue_data;
    }
