...
class ImportanceHabitats extends Modules\Component\ImetModule_Eval
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_groups = [
            'group0' => trans('form/imet/v2/evaluation.ImportanceHabitats.groups.group0'),
            'group1' => trans('form/imet/v2/evaluation.ImportanceHabitats.groups.group1'),
        ];

        $this->module_subTitle = trans('form/imet/v2/evaluation.ImportanceHabitats.module_subTitle');
        $this->module_info_EvaluationQuestion = trans('form/imet/v2/evaluation.ImportanceHabitats.module_info_EvaluationQuestion');
        $this->module_info_Rating = trans('form/imet/v2/evaluation.ImportanceHabitats.module_info_Rating');
        $this->ratingLegend = trans('form/imet/v2/evaluation.ImportanceHabitats.ratingLegend');

        $this->validation_3to10 = trans('form/imet/v2/evaluation.ImportanceHabitats.validation_3to10');
    ...
    public static function getVueData($form_id, $collection = null)
    {
        ...
        $vue_data['warning_on_save'] =  trans('form/imet/v2/evaluation.ImportanceHabitats.warning_on_save');
        return $vue_data;
    }
