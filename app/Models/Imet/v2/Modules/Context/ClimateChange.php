...
class ClimateChange extends Modules\Component\ImetModule
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_title = trans('form/imet/v2/context.ClimateChange.title');
        $this->module_fields = [
        ...
        $this->module_groups = [
            'group0' => trans('form/imet/v2/context.ClimateChange.groups.group0'),
            'group1' => trans('form/imet/v2/context.ClimateChange.groups.group1'),
            'group2' => trans('form/imet/v2/context.ClimateChange.groups.group2'),
            'group3' => trans('form/imet/v2/context.ClimateChange.groups.group3'),
            'group4' => trans('form/imet/v2/context.ClimateChange.groups.group4'),
            'group5' => trans('form/imet/v2/context.ClimateChange.groups.group5')
        ];

        $this->module_info = trans('form/imet/v2/context.ClimateChange.module_info');
        $this->ratingLegend = trans('form/imet/v2/context.ClimateChange.ratingLegend');
    ...
    public static function getVueData($form_id, $collection = null)
    {
        ...
        $vue_data['warning_on_save'] =  trans('form/imet/v2/context.ClimateChange.warning_on_save');
        return $vue_data;
    }
