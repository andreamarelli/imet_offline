...
{ 
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_code = 'I5';
        $this->module_title = trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.title');
        $this->module_fields = [
            ['name' => 'Equipment',  'type' => 'text-area',   'label' => trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.fields.Equipment')],
            ['name' => 'Importance',  'type' => 'rating-0to2',   'label' => trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.fields.Importance')],
            ['name' => 'Comments',  'type' => 'text-area',   'label' => trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.fields.Comments')],
        ];
        ...
        $this->module_info = trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.module_info');
        $this->module_info_EvaluationQuestion = trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.module_info_EvaluationQuestion');
        $this->module_info_Rating = trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.module_info_Rating');
        $this->ratingLegend = trans('form/imet/v1/evaluation.ManagementEquipmentAdequacy.ratingLegend');
...
//            $new_record['__adequacy'] = $predefined_values['additional_values'][$p];
    ...
    {
        $adequacy = array_keys(trans('form/imet/v1/context.Equipments.groups'));
