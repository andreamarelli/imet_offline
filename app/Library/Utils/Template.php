...
class Template
{
    ...
    public static function icon($icon, $color = '', $size = '', $other = '')
    {
        $color = $color ?? '';
    ...
    public static function flag($iso2, $tooltip = '')
    {
    ...
    public static function menuItem($current_page, $category, $page, $url = '')
    {
        $pageSelected = ($page == $current_page) ? ' class="selected"' : '';
        $url          = $url != '' ? $url : url('/') . '/' . $category . '/' . $page . '';
        return '<li ' . $pageSelected . '>
                    <a href="' . $url . '">' . trans('layout.menu.' . $category . '.' . $page) . '</a>
                </li>';
    }
     ...
     * @return string
     */
    public static function fileLink($relativePath, $fileName, $label = '')
    {
     ...
     * @return string
     */
    public static function fileLinkWithSize($relativePath, $fileName, $label = '')
    {
