...
class PostGis {
     ...
     * @return PostGis
     */
    public static function fromDB($geometry_field)
    {
     ...
     * @return PostGis
     */
    public static function toDB($wkt, $projection = 4326)
    {
     ...
     * @return $this
     */
    public function projectTo($target_projection = 4326)
    {
     ...
     * @return $this
     */
    public function within($geometry_field)
    {
     ...
     * @return $this
     */
    public function toGeoJSON($as = 'geojson', $maxDecimalDigits = 6)
    {
     ...
     * @return $this
     */
    public function apply($function, $arg = null)
    {
        if($arg!==null){
