...
class Module
{
    ...
    /**
     * Inject in blade-generated DOM title and average calculation for the given GROUP
     *
     * @param $view
     * @param $module_key
     * @param $beforeGroup
     ...
     * @return mixed
     */
    public static function injectGroupTitleWithAverage($view, $module_key, $beforeGroup, $title)
    {
        $searchFor = '<h5 class="green group_title_' . $module_key . '_' . $beforeGroup . '">';
        $textToAdd =
            '<div class="row">
                ...
                <div class="col-lg-3">
                    <input style="margin-top: 20px;" type="text" disabled="disabled" v-model="groupAverages.' . $beforeGroup . '" class="field-disabled input-number field-edit text-center"/>
                </div>
            </div>';
        return str_replace($searchFor, $textToAdd . $searchFor, $view);
    }
