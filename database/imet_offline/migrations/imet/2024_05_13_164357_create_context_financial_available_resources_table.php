...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('context_financial_available_resources', function (Blueprint $table) {
            ...
            $table->text('BudgetType')->nullable();
            $table->decimal('NationalBudget')->nullable();
            $table->decimal('OwnRevenues')->nullable();
            $table->decimal('Partners')->nullable();
            $table->decimal('Disputes')->nullable();
