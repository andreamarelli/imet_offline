...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('context_management_staff_communities', function (Blueprint $table) {
            ...
            $table->text('Role1')->nullable();
            $table->decimal('StaffNUmberRole1')->nullable();
            $table->text('Role2')->nullable();
            $table->decimal('StaffNUmberRole2')->nullable();
            $table->text('Role3')->nullable();
            $table->decimal('StaffNUmberRole3')->nullable();
